            ...
            <form className="jcard-form">
                <div className="settings-card">
                    ...
                    <div id="style-form">
                        ...
                        >
                            <option value="text-vertical">Vertical Text</option>
                            <option value="text-horizontal">
                                Horizontal Text
                            </option>
                            <option value="img-with-text">
                                Image With Text
                            </option>
                            <option value="img-only">Image Only</option>
                        </select>
                        ...
                        <label htmlFor="coverImagePosition">
                            Image Position:
                        </label>
                        <select
                            id="coverImagePosition"
                        ...
                        <label htmlFor="title-input-fontsize">
                            Title Size:
                        </label>
                        <input
                            type="number"
                ...
                <div className="settings-card">
                    ...
                    <div id="titles-form">
                        <div className="titles-form-inputs">
                            ...
                            <label htmlFor="sideATitle-input">
                                Side A Title:
                            </label>
                            <input
                                type="text"
                            ...
                            <label htmlFor="sideBTitle-input">
                                Side B Title:
                            </label>
                            <input
                                type="text"
                ...
                <div className="settings-card">
                    ...
                    <div id="other-form">
                        ...
                        <br />
                        <label htmlFor="sideASource-input">
                            Side A Source:
                        </label>
                        <input
                            type="text"
                        ...
                        ></input>
                        <br />
                        <label htmlFor="sideBSource-input">
                            Side B Source:
                        </label>
                        <input
                            type="text"
